...
use Yii;
use app\models\Deal;
use app\models\search\Deal as DealSearch;
 ...
 */
class DealController extends TController
{
  public function behaviors() {
    ...
    public function actionAdd()
    {
        ...
        $model->state_id = Deal::STATE_ACTIVE;
    ...
    /**
     * Truncate an existing Deal model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Deal Cleared !!!');
